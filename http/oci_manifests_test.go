...
func TestOCIManifestGet(t *testing.T) {
	...
	endpoint := addr + "/v2/testns/testrepo/manifests/sha:f4c05499df06ef6fd8fefae0639a0364dae62de6477671ea84e15af63d92b132"
...
func TestOCIManifestExists(t *testing.T) {
	reg := stori.TestRegistry(t)
...
func TestOCIManifestPut(t *testing.T) {
	reg := stori.TestRegistry(t)
